    ...
    with st.sidebar:
        with st.form("my_form"):
            ...
            with st.expander(":rainbow[**Refine your output here**]"):
                ...
                Currentyear = st.number_input("Currentyear", value=0, step=1, format="%d")
                Monthlyincome= st.number_input("Monthly income", value=0, step=1000, format="%d")
                Monthlyexpense= st.number_input("Monthly expense", value=0, step=1000, format="%d")
                current_year = st.number_input("Current Year", value=2022, step=1, format="%d")
